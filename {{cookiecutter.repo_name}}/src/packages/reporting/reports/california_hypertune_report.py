"""California Housing — hyperparameter tuning report (HTML)."""
import typing as tp
...
def create_california_hypertune_report(
    study: optuna.Study,
    params: tp.Dict[str, tp.Any],
) -> str:
    """Generate a self-contained HTML hyperparameter tuning report for California Housing.
    ...
    Args:
        ...
        params: Unused; kept for API consistency.
    ...
    meta = ReportMetaData(title="California Housing — Hyperparameter Tuning Report")
