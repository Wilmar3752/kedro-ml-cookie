"""Titanic — model interpretability report (HTML)."""
import typing as tp
...
def create_titanic_interpretability_report(
    model,
    df_train: pd.DataFrame,
    params: tp.Dict[str, tp.Any],
) -> str:
    """Generate a self-contained HTML interpretability report for the Titanic model.
    ...
    # ── Charts ────────────────────────────────────────────────────────────────
    fig_beeswarm = plot_shap_beeswarm(shap_values, max_display=20, title="SHAP Values — Titanic Survival")
    ...
    meta = ReportMetaData(title="Titanic Survival — Interpretability Report")
